# Generated by Django 3.2.7 on 2021-09-22 00:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnab_template', models.ForeignKey(help_text='Template de campos do formato CNAB', on_delete=django.db.models.deletion.DO_NOTHING, to='api.cnabtemplate', verbose_name='Template CNAB')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ManyToManyField(help_text='Template de campos do formato CNAB', related_name='import_templates', through='api.ImportCnabTemplate', to='api.CnabTemplate')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='Template importação que organiza os campos do formato CNAB', on_delete=django.db.models.deletion.DO_NOTHING, to='api.importtemplate', verbose_name='Template de Importação'),
        ),
    ]
