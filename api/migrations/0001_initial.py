    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.CharField(blank=True, max_length=255, null=True, verbose_name='Dono da Loja')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(blank=True, null=True, upload_to='parser/%Y/%m/%d/', verbose_name='Arquivo CNAB')),
